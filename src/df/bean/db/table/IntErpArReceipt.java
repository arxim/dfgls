    ...
    public int updateWriteOff(String startDate, String endDate, String hospitalCode, String tableName) {
        ...
        try {
            sql = "UPDATE " + tableName + " SET " + tableName + ".IS_WRITE_OFF = 'Y' " 
                ...
                + ", DR_TAX_406_BEF_WRITE_OFF = DR_TAX_406+DR_TAX_402 "
                //+ ", DR_TAX_406_BEF_WRITE_OFF = "
                //+"CASE WHEN TRN_DAILY.TAX_TYPE_CODE = '402' THEN TRN_DAILY.DR_TAX_402 ELSE "
                //+"CASE WHEN TRN_DAILY.TAX_TYPE_CODE = '406' THEN TRN_DAILY.DR_TAX_406 ELSE TRN_DAILY.DR_TAX_400+TRN_DAILY.DR_TAX_401 END END AS TAX "
                
                + ", WRITE_OFF_BILL_AMT = (SELECT DISTINCT E.BILL_AMOUNT " +
                                                " FROM INT_ERP_AR_RECEIPT E " +
                                                " WHERE E.BILL_NO = " + tableName + ".INVOICE_NO " +
                                                " AND E.IS_LAST_RECEIPT = 'Y' " +
                                                " AND(E.TRANSACTION_DATE >='" + startDate + "' AND E.TRANSACTION_DATE <='" + endDate + "')" +
...
+" ,TRN_DAILY.DR_TAX_402 =          CASE WHEN TRN_DAILY.WRITE_OFF_BILL_AMT > 0 AND TRN_DAILY.WRITE_OFF_RECEIPT_AMT > 0 THEN TRN_DAILY.DR_TAX_402 *          (TRN_DAILY.WRITE_OFF_RECEIPT_AMT / TRN_DAILY.WRITE_OFF_BILL_AMT) ELSE 0 END "
...
//                    + " AND(TRANSACTION_DATE BETWEEN '" + startDate + "' AND '" + endDate + "')";
    ...
    public boolean rollBackWriteOffDelete(String hospitalCode, String startDate, String endDate) {
        ...
        String sql = "UPDATE TRN_DAILY SET AMOUNT_AFT_DISCOUNT = AMOUNT_BEF_WRITE_OFF, "        	
                      ...
                      + " DR_TAX_406 = CASE WHEN TAX_TYPE_CODE = '406' THEN DR_TAX_406_BEF_WRITE_OFF ELSE 0 END, "
                      + " DR_TAX_402 = CASE WHEN TAX_TYPE_CODE = '402' THEN DR_TAX_406_BEF_WRITE_OFF ELSE 0 END "
