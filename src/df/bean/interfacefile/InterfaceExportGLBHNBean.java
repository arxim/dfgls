...
public class InterfaceExportGLBHNBean {
    ...
    public InterfaceExportGLBHNBean(String yyyy, String mm, String hospital_code){
        conn = new DBConn();
        YYYY = yyyy;
        MM = mm;
    ...
    */
    ...
    public String processAccu(){
        ...
        try{
            ...
            System.out.println("Delete complete : "+this.Hospital_code);
