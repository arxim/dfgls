...
public class InterfaceExportGLBPKBean {
    ...
    public InterfaceExportGLBPKBean(String yyyy, String mm, String hospital_code){
        conn = new DBConn();
        YYYY = yyyy;
        MM = mm;
    ...
    private String accu602103Credit(){ //transaction hp_amt
        return "INSERT INTO TEMP_GL(LINE_NO, DOCTOR_CODE, ADMISSION_TYPE_CODE,PATIENT_DEPARTMENT_CODE" +
                ...
                "WHERE (T.BATCH_NO = '' OR T.BATCH_NO IS NULL) "+
                //"AND T.GUARANTEE_NOTE <> 'ABSORB SOME GUARANTEE' "+
                "AND T.INVOICE_TYPE <> 'ORDER' AND D.ACTIVE = '1' AND T.ACTIVE = '1' "+
    ...
    private String accu203104Credit(){
        return "INSERT INTO TEMP_GL(LINE_NO, DOCTOR_CODE, ADMISSION_TYPE_CODE,PATIENT_DEPARTMENT_CODE," +
                ...
                "H.AC_ACCOUNT_CODE AS ACCOUNT_CODE, "+
    ...
    public String processAccu(){
        ...
        try{
            ...
            System.out.println("Delete previous AC complete : "+this.Hospital_code);
            ...
            conn.commitDB();
            System.out.println("Commit Process Accu : "+this.Hospital_code);
        }catch(Exception err){
    ...
    public String processGlAccount(){
        ...
        try{
            ...
            System.out.println("Delete previous GL complete : "+this.Hospital_code);
            ...
            conn.commitDB();
            System.out.println("Commit Process GL : "+this.Hospital_code);
        }catch(Exception err){
