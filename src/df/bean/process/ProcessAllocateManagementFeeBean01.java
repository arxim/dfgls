...
public class ProcessAllocateManagementFeeBean01 implements ProcessMaster{
	 ...
	 * @param hospitalCode
	 */
	public ProcessAllocateManagementFeeBean01(String mm , String yyyy , String hospitalCode , String term){ 
	...
	public boolean doProcess() {
		...
		try { 
			...
			//System.out.println(this.getDeleteTrnExpenseOnRunProcess());
			//System.out.println();
	...
	private String getSQL(){
		return  " INSERT INTO TRN_EXPENSE_DETAIL (" +
			   ...
			   " FROM  ( " + 
					 ...
					 " SELECT AJ.DOCTOR_CODE AS DOCTOR_CODE , DOCTOR.DEPARTMENT_CODE , SUM(AJ.AMOUNT * AJ.EXPENSE_SIGN) AS DR_NET_PAID_AMT " + 
					 " FROM DOCTOR " +  
					 ...
					 " WHERE DOCTOR.HOSPITAL_CODE = '" + this.hospitalCode +"' " +
					 " AND AJ.YYYY = '" + this.yyyy + "' AND AJ.MM = '" + this.mm + "'" +  
					 " AND AJ.BATCH_NO = '' AND DOCTOR.PAYMENT_TIME = '" + this.term + "'" + 
	...
	private String getDeleteTrnExpenseOnRunProcess(){ 
		return  "DELETE FROM TRN_EXPENSE_DETAIL  WHERE HOSPITAL_CODE = '" + this.hospitalCode + "' AND MM = '" + this.mm + "' AND YYYY = '" + this.yyyy + "' AND LINE_NO LIKE 'MF" + this.yyyy + this.mm + "%'";
	}
}
