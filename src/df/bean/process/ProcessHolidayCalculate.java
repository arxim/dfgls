			...
			if(INCLUDE.equals("Y")){
				...
				while(rsMethod2.next()){
					...
					String sqlcommand =
							...
							+"TRN_DAILY.DR_AMT = (CASE WHEN TRN_DAILY.COMPUTE_DAILY_USER_ID != 'Employee' THEN TRN_DAILY.AMOUNT_AFT_DISCOUNT * "+rsMethod2.getDouble("NOR_ALLOCATE_PCT")/100+" ELSE TRN_DAILY.AMOUNT_AFT_DISCOUNT * TRN_DAILY.NOR_ALLOCATE_PCT / 100 END) * ("+rsMethod2.getDouble("NOR_ALLOCATE_PCT")/100+"), "
