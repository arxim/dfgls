			...
			if(INCLUDE.equals("Y")){
				...
				while(rsMethod2.next()){
					...
					String sqlcommand =
							...
							+"TRN_DAILY.DR_AMT = (CASE WHEN TRN_DAILY.COMPUTE_DAILY_USER_ID = 'Employee' THEN TRN_DAILY.DR_AMT ELSE TRN_DAILY.AMOUNT_AFT_DISCOUNT END /100)*("+rsMethod2.getDouble("NOR_ALLOCATE_PCT")+"), "
							+"TRN_DAILY.DR_TAX_406 = (CASE WHEN TRN_DAILY.COMPUTE_DAILY_USER_ID = 'Employee' THEN TRN_DAILY.DR_AMT ELSE TRN_DAILY.AMOUNT_AFT_DISCOUNT END /100)*("+rsMethod2.getDouble("NOR_ALLOCATE_PCT")+"), "
