...
public class Tax402Bean {
    ...
    private boolean insertExpenseTax(String doctor){
		...
		"YYYY,MM,NOTE,USER_ID) SELECT HOSPITAL_CODE, DOCTOR_CODE, " +
		"'TAX 40(2)','40201',YYYY+MM+'01',NET_TAX_MONTH,'0','-1', "+
		"'203401','EXTAX402','400',YYYY,MM,'Expense Tax of Month','ProcessTax' "+
		"FROM SUMMARY_TAX_402 WHERE HOSPITAL_CODE = '"+this.hospital+"' AND " +
		"DOCTOR_CODE = '"+doctor+"' AND "+
    	"NORMAL_TAX_MONTH > 0 AND YYYY = '"+this.year+"' AND MM = '"+this.month+"'";
