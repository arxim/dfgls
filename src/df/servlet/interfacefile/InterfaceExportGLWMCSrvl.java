...
import df.bean.interfacefile.InterfaceExportGLWMCBean;
 ...
 * @author USER
 */
public class InterfaceExportGLWMCSrvl extends HttpServlet {
   HttpSession session;
    /** 
    ...
    throws ServletException, IOException {
        ...
        InterfaceExportGLWMCBean gl = new InterfaceExportGLWMCBean(YYYY, MM, hospital_code);
        String countdata = "0";
        try {
