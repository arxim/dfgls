...
import df.bean.process.DistributeRevenueBean;
/**
 * Servlet implementation class for Servlet: ProcessDistributeRevenueSrvl
 *
 */
public class ProcessDistributeRevenueSrvl extends HttpServlet {
	   private DBConnection conn = null;
	   private DBConn cdb = null;
	   private DistributeRevenueBean gpb;
	    /* (non-Java-doc)
		...
		public void init() throws ServletException {
	        ...
	        try {
	            cdb.setStatement();
	            gpb = new DistributeRevenueBean(cdb);
	            //gr = new Old(cdb);
	    ...
	    throws ServletException, IOException {
	        ...
	        try 
	        {
	            ...
	            String rollback_type = request.getParameter("ROLLBACK");
	            boolean st = true;
	           ...
	           // {
	                try 
	                {
	                    st = gpb.prepareProcess(month, year, hospitalCode, process_type,rollback_type);
	                    out.print("<RESULT><SUCCESS>" + st + "</SUCCESS></RESULT>");
	                }
	                catch (Exception  e) 
	                {
	                    System.out.println("Prepare error : "+e+" / Process : "+month+year+hospitalCode+process_type+rollback_type);
