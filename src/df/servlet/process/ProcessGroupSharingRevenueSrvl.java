...
//        System.out.println(stm);
	...
	private boolean rollbackTransaction(String hospital_code,String start_date, String end_date) {
        ...
        String stm ="UPDATE TRN_DAILY\r\n" + 
        		...
        		"FROM \r\n" + 
        		"(\r\n" + 
        		"	SELECT '45' AS PCT, 'PT|'+SSR.GROUP_CODE AS NOTE, TD.INVOICE_NO,TD.LINE_NO,PM.ORDER_ITEM_CODE AS STT, TD.ORDER_ITEM_CODE ,SSR.HOSPITAL_CODE, SSR.GROUP_CODE,SSR.TYPE, TD.DOCTOR_CODE, TD.VERIFY_DATE, TD.AMOUNT_AFT_DISCOUNT, TD.AMOUNT_AFT_DISCOUNT*0.45 AS PCT_AMOUNT\r\n" + 
        		...
        		"	union all\r\n" + 
        		"\r\n" + 
        		"	SELECT '100' AS PCT, 'PT|'+SSR.GROUP_CODE AS NOTE, TD.INVOICE_NO,TD.LINE_NO,PM.ORDER_ITEM_CODE AS STT,TD.ORDER_ITEM_CODE,SSR.HOSPITAL_CODE, SSR.GROUP_CODE,SSR.TYPE, TD.DOCTOR_CODE, TD.VERIFY_DATE, TD.AMOUNT_AFT_DISCOUNT, TD.AMOUNT_AFT_DISCOUNT*1 AS PCT_AMOUNT\r\n" + 
        		"	FROM TRN_DAILY TD LEFT JOIN STP_SHARING_REVENUE SSR  \r\n" + 
        		"	ON TD.HOSPITAL_CODE = SSR.HOSPITAL_CODE AND TD.DOCTOR_CODE = SSR.DOCTOR_CODE and SSR.TYPE = 'DF'\r\n" + 
        		"	LEFT JOIN STP_PROMOTION_ITEM_MAPPING PM \r\n" + 
        		"	ON TD.HOSPITAL_CODE = PM.HOSPITAL_CODE AND TD.ORDER_ITEM_CODE = PM.ORDER_ITEM_CODE\r\n" + 
        		...
        		"	union all\r\n" + 
        		"\r\n" + 
        		"	SELECT '35' AS PCT, 'PT|'+SSR.GROUP_CODE AS NOTE, TD.INVOICE_NO,TD.LINE_NO,PM.ORDER_ITEM_CODE AS STT,TD.ORDER_ITEM_CODE,SSR.HOSPITAL_CODE, SSR.GROUP_CODE,SSR.TYPE, TD.DOCTOR_CODE, TD.VERIFY_DATE, TD.AMOUNT_AFT_DISCOUNT, TD.AMOUNT_AFT_DISCOUNT*0.35 AS PCT_AMOUNT\r\n" + 
        		"	FROM TRN_DAILY TD LEFT JOIN STP_SHARING_REVENUE SSR  \r\n" + 
        		"	ON TD.HOSPITAL_CODE = SSR.HOSPITAL_CODE AND TD.DOCTOR_CODE = SSR.DOCTOR_CODE and SSR.TYPE = 'DF'\r\n" + 
